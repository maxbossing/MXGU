...
inline fun literalText(
    baseText: String = "",
    builder: de.maxbossing.mxpaper.chat.LiteralTextBuilder.() -> Unit = { }
) = de.maxbossing.mxpaper.chat.LiteralTextBuilder(baseText).apply(builder).build()
...
class LiteralTextBuilder(val internalText: Component) {
    ...
    inline fun text(
        ...
        siblingText = siblingText.append(de.maxbossing.mxpaper.chat.LiteralTextBuilder(text).apply(builder).build())
    }
    ...
    inline fun component(
        ...
        siblingText = siblingText.append(de.maxbossing.mxpaper.chat.LiteralTextBuilder(component).apply(builder).build())
    }
    ...
    inline fun hoverText(
        ...
        hoverEvent = HoverEvent.hoverEvent(
            ...
            de.maxbossing.mxpaper.chat.LiteralTextBuilder(text).apply(builder).build()
        )
    }
    ...
    /**
     * Builds the final Component from the configuration done in [LiteralTextBuilder]
