package de.maxbossing.mxpaper.pluginmessages
 ...
 * using this method!
 * @param subChannel The subChannel to send over
 * @param content The Content of the Message
 * @param responseTimeout How long to wait for the Response
 * @param onResponse Callback when the response is recieved
