 ...
 * @param priority The [EventPriority] this listener has
 * @param ignoreCancelled If manual cancellation should be avoided
 * @see de.maxbossing.mxpaper.event.listen
 */
...
inline fun <reified T : Event> listen(
    priority: EventPriority = MXPaperConfiguration.events.eventPriority,
    ignoreCancelled: Boolean = MXPaperConfiguration.events.ignoreCancelled,
    register: Boolean = MXPaperConfiguration.events.autoRegistration,
