...
/**
 * Add a synchronous [ChainedRunnablePart]
 */
fun <T, R, U> ChainedRunnablePart<T, R>.thenSync(runnable: (R) -> U) = thenDo(true, runnable)

/**
 * Add an asynchronous [ChainedRunnablePart]
 */
