...
package de.maxbossing.mxpaper.runnables

import de.maxbossing.mxpaper.main.PluginInstance
import org.bukkit.Bukkit
import org.bukkit.scheduler.BukkitRunnable

internal object MXRunnableHolder : AutoCloseable {
    /**
...
abstract class MXPaperRunnable(
...
fun task(
    ...
    runnable: ((MXPaperRunnable) -> Unit)? = null,
): MXPaperRunnable? {
    if (howOften != null && howOften == 0L) return null
    val bukkitRunnable = object : MXPaperRunnable() {
 ...
 * @param sync Whether the runnable should be executed sync or async
...
/**
 * Executes the given [runnable]
 * @param sync If the runnable should run synchronous or asynchronous
 * @param runnable The runnable to execute
 */
